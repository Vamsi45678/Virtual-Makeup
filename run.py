...
header = "SUBMITTED BY"
second_text = "T. Vamsi Krishna"
styled_header = f"<div style='text-align: right; margin-top: 50px; font-size: 24px;'>{header}</div>"
styled_text1 = f"<div style='text-align: right; margin-top: 10px; font-size: 22px;'>{second_text}</div>"
